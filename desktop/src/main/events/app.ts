...
export function registerApp(): void {
  ...
  ipcMain.handle(IpcEvents.OPEN_EXTERNAL_URL, openExternalUrl)
...
async function openExternalUrl(_: IpcMainInvokeEvent, url: string, options?: OpenExternalOptions): Promise<void> {
  await shell.openExternal(url, options).catch(console.error)
}
